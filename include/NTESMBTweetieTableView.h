...
@property (nonatomic,  assign) UIEdgeInsets normalEdgeInset;
@property (nonatomic,  assign) UIEdgeInsets bottomEdgeInset;
@property (nonatomic,  assign) UIEdgeInsets topEdgeInset;
@property (nonatomic,  retain) NTESMBDragDownInfoView *topInfoView;
@property (nonatomic,  assign) CGFloat dragDownOffset;
@property (nonatomic,  retain) NTESMBDragDownBottomInfoView *bottomInfoView;
...
- (void) setDragEffect:(BOOL)status;
